...
12. [Phased Effort Estimate](#12-phased-effort-estimate)
...
| Products    | Search/filter list, quick stock edit inline, bulk CSV upload, individual edit     |
...
## 12. Phased Effort Estimate

| Phase                          | Scope                                                                                                                                                                        | Solo Dev        | 2 Devs        |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ------------- |
| **1 — Foundation**             | Scaffold, Firebase setup, auth, all constants/types, product listing, collection pages, product detail, cart (Zustand), WhatsApp checkout flow, INR formatting               | 2–3 wks         | 1–1.5 wks     |
| **2 — Core UX**                | Homepage (all dynamic sections from Firestore), search + filters, wishlist, account dashboard (orders, addresses), responsive nav/footer, skeleton loaders, announcement bar | 2–3 wks         | 1–1.5 wks     |
| **3 — Order Tracking**         | Status state machine (Firestore + transitions), customer stepper UI (real-time), admin status change form, WA customer notifications                                         | 1 wk            | 0.5 wks       |
| **4 — Inventory via WhatsApp** | Cloud Functions (onProductWrite alerts), WA webhook bot (all commands), admin restock UI                                                                                     | 1–2 wks         | 0.5–1 wks     |
| **5 — Content & SEO**          | Blog, policy pages, FAQ, testimonials carousel, rich-text editor in admin, on-demand ISR, sitemap, Next.js metadata API, OG images                                           | 1–2 wks         | 0.5–1 wks     |
| **6 — Admin Panel**            | Full admin UI (products CRUD, bulk upload, order management, content editor, config editor)                                                                                  | 2–3 wks         | 1–1.5 wks     |
| **7 — Loyalty & Pre-orders**   | FCC Coins earn/redeem, discount codes, pre-order badge + flow, flex-pay tagging                                                                                              | 1–2 wks         | 0.5–1 wks     |
| **Total**                      |                                                                                                                                                                              | **10–16 weeks** | **5–8 weeks** |
