...
import { getBrandServer, getProductsServer, getAllFranchisesServer } from "@/lib/firebase/server";
...
export default async function BrandPage({
  ...
  const [brand, products, allFranchises] = await Promise.all([
    getBrandServer(slug).catch(() => null),
    getProductsServer({
      brand: slug,
      ...
      >
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="w-full md:w-56 shrink-0">
            <ProductFilterSidebar franchises={allFranchises} />
          </div>
