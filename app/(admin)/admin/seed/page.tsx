...
export default function AdminSeedPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      {/* Dev-only notice */}
      <div className="rounded-md border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-800 font-medium">
        ⚠️ This page calls a <strong>dev-only</strong> API route (<code>/api/admin/seed</code>). It returns 404 in production.
      </div>
